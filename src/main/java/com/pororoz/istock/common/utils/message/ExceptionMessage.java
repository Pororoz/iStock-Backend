...
public class ExceptionMessage {
  ...
  public static final String INVALID_SUB_ASSY_BOM_REQUEST = "Sub assy BOM은 sub assy의 productNumber가 필요하고 partId가 null이어야 합니다.";
  ...
  public static final String BOM_SUB_ASSY_NUMBER_DUPLICATED =
      "제품의 BOM에 이미 같은 sub assy number가 존재합니다. 중복된 sub assy는 등록할 수 없습니다.";
